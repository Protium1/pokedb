...
class PokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poke" do
    assert_difference('Poke.count') do
      post pokes_url, params: { poke: { acquired: @poke.acquired, generation: @poke.generation, name: @poke.name, number: @poke.number, picture: @poke.picture } }
    end
  ...
  test "should update poke" do
    patch poke_url(@poke), params: { poke: { acquired: @poke.acquired, generation: @poke.generation, name: @poke.name, number: @poke.number, picture: @poke.picture } }
